...
export default function ComoFunciona() {
  ...
  return (
    <section
      ...
      className="relative bg-[#0e0e0f] py-24 sm:py-32"
    >
        ...
        <div className="mt-16 space-y-4">
          {data.steps.map((step, i) => (
            <Reveal key={i} delay={i * 0.12}>
              <div className="group grid md:grid-cols-12 gap-6 items-center border-t border-white/10 py-8 transition-colors duration-500 hover:border-accent-nb/40">
